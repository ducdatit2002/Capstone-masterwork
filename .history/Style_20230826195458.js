function dark_mode(){
    const banner__photo = document.querySelector('.banner__content');
     banner__photo.style.background = 'linear-gradient(to right, #000, rgba(255, 255, 255, 0.92))';
    const banner__photo1 = document.querySelector('.ourClients ');
     banner__photo1.style.background = 'linear-gradient(to right, #000, rgba(255, 255, 255, 0.92))';
    ...
    for ( var section__color of number__sections ){
        section__color.style.backgroundColor = '#191c1d';
    }
    ...
    var another_light_black = document.querySelectorAll(`.another_light_black`);
    for (var another_light_black of another_light_black) {
      another_light_black.style.backgroundColor = "#191c1d";
    }
...
function light_mode(){
    ...
    const banner__photo1 = document.querySelector('.ourClients ');
     banner__photo1.style.background = 'linear-gradient(to right, #fff, rgba(255, 255, 255, 0.92))';
    const email_BG = document.querySelector('.end-column');
